...
ESSENTIAL_FIELDS = {
    ...
    "compass~google-maps-extractor": ["title", "url", "address", "phone", "website", "totalScore", "reviewsCount", "categoryName"],
    "compass~Google-Maps-Reviews-Scraper": ["title", "name", "url", "text", "stars", "publishedAtDate", "likesCount", "responseFromOwnerText"],
    # Booking.com
    "voyager~booking-scraper": ["name", "url", "address", "rating", "reviewScore", "price", "facilities", "description"],
    "voyager~booking-reviews-scraper": ["reviewTitle", "reviewDate", "rating", "userName", "userLocation", "roomInfo", "stayDate", "reviewTextParts"],
    # Facebook
    "apify~facebook-ads-scraper": ["pageName", "snapshot.body.text", "publisherPlatform", "snapshot.displayFormat", "isActive", "startDateFormatted", "snapshot.ctaText", "snapshot.linkUrl", "spend"],
    "apify~facebook-pages-scraper": ["title", "pageUrl", "email", "phone", "website", "address", "likes", "followers"],
    "apify~facebook-posts-scraper": ["url", "text", "timestamp", "likes", "comments", "shares", "pageName"],
    "apify~facebook-reels-scraper": ["url", "text", "user.name", "playCount", "likesCount", "commentsCount", "sharesCount", "time"],
    ...
    "apify~facebook-followers-following-scraper": ["title", "url", "type", "subtitle"],
    "apify~facebook-reviews-scraper": ["text", "isRecommended", "date", "user.name", "user.profileUrl", "pageName", "likesCount"],
    ...
    "apify~instagram-post-scraper": ["url", "ownerUsername", "caption", "likesCount", "commentsCount", "timestamp", "type", "displayUrl"],
    "apify~instagram-comment-scraper": ["text", "ownerUsername", "timestamp", "ownerProfilePicUrl", "id", "postId"],
    "apify~instagram-reel-scraper": ["url", "ownerUsername", "caption", "videoViewCount", "likesCount", "commentsCount", "timestamp", "videoDuration"],
    ...
    "streamers~youtube-comments-scraper": ["comment", "author", "voteCount", "replyCount", "videoId", "pageUrl", "title"],
    "streamers~youtube-channel-scraper": ["aboutChannelInfo.channelName", "aboutChannelInfo.channelUrl", "aboutChannelInfo.numberOfSubscribers", "aboutChannelInfo.channelTotalViews", "aboutChannelInfo.channelTotalVideos", "aboutChannelInfo.channelDescription", "aboutChannelInfo.channelJoinedDate"],
    # TikTok
    ...
    "clockworks~tiktok-video-scraper": ["webVideoUrl", "authorMeta.name", "text", "playCount", "diggCount", "commentCount", "shareCount", "createTimeISO"],
